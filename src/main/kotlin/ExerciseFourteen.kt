 ...
 * Exercicio 14
 *
 * Escreva um programa que leia três números inteiros e determine se a soma dos dois primeiros é igual ao terceiro.
 *
...
class ExerciseFourteen {
     ...
     */
    fun logicExerciseFourteen(valueOne: Int, valueTwo: Int, valueThree: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
}