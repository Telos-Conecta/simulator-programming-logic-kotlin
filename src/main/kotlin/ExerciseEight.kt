 ...
 * Exercicio 8
 *
 * Escreva um programa que leia dois números inteiros e determine se a diferença entre eles é par ou ímpar.
 *
...
class ExerciseEight {
     ...
     */
    fun logicExerciseEight(valueOne: Int, valueTwo: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
