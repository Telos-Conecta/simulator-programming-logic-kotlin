 ...
 * Exercicio 19
 *
 * Escreva um programa que leia quatro números inteiros e determine se a soma dos três primeiros é maior que o quarto.
 *
...
class ExerciseNineteen {
     ...
     */
    fun logicExerciseNineteen(valueOne: Int, valueTwo: Int, valueThree: Int, valueFour: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
