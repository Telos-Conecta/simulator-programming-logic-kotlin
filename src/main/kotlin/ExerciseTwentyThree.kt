 ...
 * Exercicio 23
 *
 * Escreva um programa que leia cinco números inteiros e determine se a soma dos três primeiros é menor que o
 * quarto mais o quinto.
 *
...
class ExerciseTwentyThree {
     ...
     * @param valueFour valor inteiro.
     * @param valueFive valor inteiro.
     * @return retorna valor string com resultado do desafio.
     */
    fun logicExerciseTwentyThree(
        valueOne: Int,
        valueTwo: Int,
        valueThree: Int,
        valueFour: Int,
