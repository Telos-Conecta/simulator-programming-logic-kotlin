 ...
 * Exercicio 12
 *
 * Escreva um programa que leia três números inteiros e determine se a soma dos dois primeiros é maior que o terceiro.
 *
...
class ExerciseTwelve {
     ...
     */
    fun logicExerciseTwelve(valueOne: Int, valueTwo: Int, valueThree: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
