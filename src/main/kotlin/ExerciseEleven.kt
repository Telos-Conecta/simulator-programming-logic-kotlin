 ...
 * Exercicio 11
 *
 * Escreva um programa que leia três números inteiros e determine se o primeiro é divisível pelo segundo e o
 * segundo é divisível pelo terceiro.
 *
...
class ExerciseEleven {
     ...
     */
    fun logicExerciseEleven(valueOne: Int, valueTwo: Int, valueThree: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
