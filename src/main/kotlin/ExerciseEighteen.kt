 ...
 * Exercicio 18
 *
 * Escreva um programa que leia quatro números inteiros e determine se a soma dos três primeiros é igual ao quarto.
 *
...
class ExerciseEighteen {
     ...
     */
    fun logicExerciseEighteen(valueOne: Int, valueTwo: Int, valueThree: Int, valueFour: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
