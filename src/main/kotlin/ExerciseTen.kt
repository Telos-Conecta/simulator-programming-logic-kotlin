 ...
 * Exercicio 10
 *
 * Escreva um programa que leia dois números inteiros e determine se o primeiro é divisível pelo segundo.
 *
...
class ExerciseTen {
     ...
     */
    fun logicExerciseTen(valueOne: Int, valueTwo: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
