 ...
 * Exercicio 20
 *
 * Escreva um programa que leia quatro números inteiros e determine se a soma dos três primeiros é menor que o quarto.
 *
...
class ExerciseTwenty {
     ...
     */
    fun logicExerciseTwenty(valueOne: Int, valueTwo: Int, valueThree: Int, valueFour: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
