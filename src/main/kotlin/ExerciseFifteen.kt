 ...
 * Exercicio 15
 *
 * Escreva um programa que leia três números inteiros e determine se a diferença entre o primeiro e o
 * segundo é maior que o terceiro.
 *
...
class ExerciseFifteen {
     ...
     */
    fun logicExerciseFifteen(valueOne: Int, valueTwo: Int, valueThree: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
