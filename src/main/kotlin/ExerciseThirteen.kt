 ...
 * Exercicio 13
 *
 * Escreva um programa que leia três números inteiros e determine se a soma dos dois primeiros é menor que o terceiro.
 *
...
class ExerciseThirteen {
     ...
     */
    fun logicExerciseThirteen(valueOne: Int, valueTwo: Int, valueThree: Int): String {
        // LOGICA DO EXERCICIO
        return ""
    }
